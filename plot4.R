...
plot(x,active_power,type="l",xaxt='n',ylab="Global Active Power",xlab="")
axis(1,at=c(1,nrow(data) %/% 2,nrow(data)),labels=dayNames)

plot(x,voltage,type="l",xaxt='n',ylab="Voltage",xlab="datetime")
axis(1,at=c(1,nrow(data) %/% 2,nrow(data)),labels=dayNames)
...
plot(x,reactive_power,type="l",xaxt='n',ylab="Global_reactive_power",xlab="datetime")
axis(1,at=c(1,nrow(data) %/% 2,nrow(data)),labels=dayNames)
dev.off()